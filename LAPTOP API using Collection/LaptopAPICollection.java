...
class LaptopAPICollection{
	...
	char ch2 = ' ';
		...
		do{
				...
				System.out.print("Do you want to continue with this API ?(y/n): ");
	...
	public void addLaptop(){
		...
		java.util.Scanner sc = new java.util.Scanner(System.in);
		System.out.print("How many Laptop you want to enter? ");
		int amount = sc.nextInt();
		for(int i = 0; i < amount; i++)
		{
			System.out.print("Enter the Index of Laptop:- ");
			int id = sc.nextInt();
		...
		for (Object ref : list ) {
			...
			if(((Laptop)ref).getId().equals(lpId))
			{
				...
				do{
					...
					System.out.print("Do you want to continue with updating?(y/n): ");
			...
			{
				System.out.println("Laptop ID is not present in the Laptop Details!!\n");
